<script>
  ...
  //  Check if user is admin (only admin can add teachers)
  $: canAddTeacher = $authStore?.role === 'admin';
  
  console.log('User role for adding teacher:', $authStore?.role);
  ...
  <div class="container-fluid py-4">
    <div class="card shadow-sm teachers-card">
      ...
      <div class="card-body">
        ...
        <!-- ADD TEACHER FORM - Only show if user is admin -->
        {#if showForm && canAddTeacher}
